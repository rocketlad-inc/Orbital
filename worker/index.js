...
const FEATURE_MODULES = [lobby, factions, messages, senate, trades, market, tradeSummary, tradeRoutesV2, state, actions, fleets, discord, discordOauth, analytics, configAdmin, store, economy, devlog];
