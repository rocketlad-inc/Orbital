...
import * as tradeSummary from './tradeSummary.js';
...
const FEATURE_MODULES = [lobby, factions, messages, senate, trades, market, wars, tradeSummary, tradeRoutesV2, state, actions, fleets, discord, discordOauth, analytics, configAdmin, store, economy, devlog];
