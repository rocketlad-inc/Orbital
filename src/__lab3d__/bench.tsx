...
import { platedHullMaterial, spaceEnv } from '../render3d/fx3d';
...
async function shoot(
  ...
  const m = new THREE.Mesh(
    ...
    [platedHullMaterial('#7fb2e8', variant), platedHullMaterial('#e8a33f', variant, true)],
  );
