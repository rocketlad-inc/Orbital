      ...
      >
        <div style={{
          ...
          <div>
            ...
            <div style={{ fontSize: 10, color: '#6b8195', marginTop: 2 }}>
          ...
          <button
            ...
            style={{
              ...
              color: '#6b8195', cursor: 'pointer', fontSize: 14,
        ...
        <form onSubmit={submit} style={{ padding: 16, color: '#d8e4ee', fontSize: 11 }}>
          {!isCounter && (
            <div style={{ marginBottom: 12 }}>
              <div style={{ fontSize: 9, color: '#6b8195', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 4 }}>
                Negotiating with
              </div>
              <select
                className="mp-select"
          ...
          {isCounter && (
            <div style={{ marginBottom: 12, fontSize: 10, color: '#6b8195' }}>
              Replying to{' '}
...
function ColumnEditor({
  ...
  return (
    <div style={{
      ...
      <div style={{
        fontSize: 9, color: '#6b8195', letterSpacing: '0.1em',
      ...
      {hint && (
        <div style={{ fontSize: 8, color: '#6b8195', marginTop: 6, fontStyle: 'italic' }}>
          {hint}
        </div>
      )}
    </div>
