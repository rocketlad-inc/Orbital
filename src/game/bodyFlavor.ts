...
export const BODY_FLAVOR: Record<string, string> = {
  ...
  // Asteroid belt
  ceres: "The largest body in the belt, round enough to be a world in its own right, with bright salt deposits glinting where briny water once welled up from below. There may be a buried ocean still in there, sealed under ice and rock. Rich in metal and rumor both — if a lost city sleeps anywhere in the belt, this is where you'd look first.",

  vesta: "A battered protoplanet that never finished forming, scarred by an impact so enormous it flung fragments all the way to Earth as meteorites. Its core is iron, its crust is stone, and its metal yield is among the highest in the belt. A broken world that almost became something more — and may yet hold the bones of someone who got there first.",
  ...
  hygiea: "The dark, quiet fourth giant of the belt — round despite its modest mass, smooth where its siblings are scarred, as if a long-ago shattering reassembled itself into something almost peaceful. It gives up fuel and metal in equal, unspectacular measure. An overlooked world, which is exactly the kind that keeps its secrets longest.",

  juno: "One of the first asteroids ever found, an irregular lump of rocky metal that flares unexpectedly bright as it tumbles through the sun's light. Decent credits, decent metal, and the same belt-deep chance of treasure underfoot. Small, sharp-edged, and easy to pass by — which is why something might still be waiting on it.",
  ...
  rhea: "Saturn's second-largest moon, a frozen world of nearly pure ice and rock that may once have worn a faint, fragile ring of its own. Quiet and balanced in what it offers — a little fuel, a little metal, a little of everything. The kind of cold, clean waypoint where something could lie undisturbed for ages.",
  ...
  miranda: "A small, shattered moon that looks stitched together from mismatched parts — cliffs miles high, terrain that seems torn apart and reassembled by something. Modest metal, modest secrets, outsized strangeness. A jigsaw world that raises more questions than it answers, which is exactly why it's worth the landing.",

  ariel: "The brightest of Uranus's moons, its surface laced with valleys that may once have flowed with icy slush, younger and smoother than its battered siblings. Balanced credits and metal, nothing extreme. A clean, reflective face that has clearly reshaped itself before — and could be hiding what it buried in the process.",

  umbriel: "The darkest of the family, an ancient, dim sphere that drinks the light and gives little back, save for one mysterious bright ring on its surface that no one has ever fully explained. Metal-rich and tight-lipped. The shadowed sibling, keeping a secret it has held longer than any of them.",

  titania: "The largest of Uranus's moons, cut through by enormous canyons where the crust pulled itself apart as a buried ocean froze and expanded long ago. Solid metal, even yields, a respectable haul. A scarred and spacious world with room enough to hide whatever drifted out this far.",

  oberon: "The outermost major moon, an old red-tinged world pocked with craters whose floors are stained dark by some material welling up from below. Good credits and metal for those who come this far. The last waypoint before the giant's reach gives out — and the loneliest place a secret could keep.",
  ...
  proteus: "A dark, lumpy moon riding the very edge of where a body that size can hold itself together as a sphere — any smaller and it would simply be a rock. Balanced metal and yields, nothing flashy. An overlooked guardian at Neptune's gate, the sort of place a careful surveyor leaves things behind.",
  ...
  quaoar: "A small frozen world that defies the rules by wearing a ring no one expected it could hold, orbiting impossibly far out where the math says no ring should survive. Metal-rich and strange. One of the five gate-bearers — a world that already keeps one impossible thing, and might keep another.",
